...
export interface IFetchDiscoveryRecordsResponse {

    /** FetchDiscoveryRecordsResponse records */
    records?: (ISignedDiscoveryRecord[]|null);
}

/** Represents a FetchDiscoveryRecordsResponse. */
export class FetchDiscoveryRecordsResponse implements IFetchDiscoveryRecordsResponse {

    /**
     * Constructs a new FetchDiscoveryRecordsResponse.
     * @param [properties] Properties to set
     */
    constructor(properties?: IFetchDiscoveryRecordsResponse);
     ...
     * @param [properties] Properties to set
     * @returns FetchDiscoveryRecordsResponse instance
     */
    public static create(properties?: IFetchDiscoveryRecordsResponse): FetchDiscoveryRecordsResponse;
     ...
     * @param message FetchDiscoveryRecordsResponse message or plain object to encode
     * @param [writer] Writer to encode to
     * @returns Writer
     */
    public static encode(message: IFetchDiscoveryRecordsResponse, writer?: $protobuf.Writer): $protobuf.Writer;
     ...
     * @returns Writer
     */
    public static encodeDelimited(message: IFetchDiscoveryRecordsResponse, writer?: $protobuf.Writer): $protobuf.Writer;

    /**
     * Decodes a FetchDiscoveryRecordsResponse message from the specified reader or buffer.
     * @param reader Reader or buffer to decode from
     * @param [length] Message length if known beforehand
     * @returns FetchDiscoveryRecordsResponse
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): FetchDiscoveryRecordsResponse;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): FetchDiscoveryRecordsResponse;
     ...
     * @returns FetchDiscoveryRecordsResponse
     */
    public static fromObject(object: { [k: string]: any }): FetchDiscoveryRecordsResponse;

    /**
     * Creates a plain object from a FetchDiscoveryRecordsResponse message. Also converts values to other types if specified.
     * @param message FetchDiscoveryRecordsResponse
     * @param [options] Conversion options
     * @returns Plain object
     */
    public static toObject(message: FetchDiscoveryRecordsResponse, options?: $protobuf.IConversionOptions): { [k: string]: any };
