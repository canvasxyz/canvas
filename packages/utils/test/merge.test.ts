...
test("merging objects overwrites fields in the object", async (t) => {
    ...
    t.deepEqual(
        merge({ a: null, b: -89, c: Infinity }, { b: [4, 5, 6], c: "string", d: 1 }),
        { a: null, b: -89, c: Infinity, d: 1 }
    )
    t.deepEqual(
        merge({ a: 1, b: { c: {}, e: "f" } }, { a: { b: 2 }, b: { c: 1, d: {} } }),
        { a: 1, b: { c: {}, d: {}, e: "f" }}
    )
    t.deepEqual(
        merge({ a: { b: { c: { d: { e: {} } } } } }, { a: { c: {}, }, b: { c: { d: {},  e: {} } } }),
        { a: { b: { c: { d: { e: {} } } }, c: {} }, b: { c: { d: {}, e: {} } } }
    )
})
