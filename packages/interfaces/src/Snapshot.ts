...
// export type SnapshotContract = { hash: string | null } & ({ file: string } | { actions: SnapshotActionSchema, models: SnapshotModelSchema })
// export type SnapshotActionSchema = Record<string, string>
// export type SnapshotModelSchema = Record<string, Record<string, PropertyType | IndexInit[] | string>>
