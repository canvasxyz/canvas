...
export class SIWFSigner extends AbstractSessionSigner<SIWFSessionData> {
	 ...
	 */
	public static parseSIWFMessage(siwfMessage: string, siwfSignature: string): { authorizationData: SIWFSessionData, custodyAddress: string, topic: string } {
		...
		const canvasDelegateAddress = siweMessage.requestId.slice(siweMessage.requestId.indexOf(':', siweMessage.requestId.indexOf(':') + 1) + 1)
