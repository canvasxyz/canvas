...
// 		const { identity, address, authorizationData, timestamp, blockhash, duration } = session

// 		assert(Ed25519Signer.didKeyPattern.test(identity), "invalid signing key")
...
// 			this.#sessionSigner.signTypedData(message.topic)
