	...
	t.deepEqual(core.messageStore.database.prepare("SELECT * FROM actions").all(), [
		{
			...
			callArgs: toBuffer(cbor.encode(sourceAction.payload.callArgs)),
			chain: "ethereum",
			chain_id: "1",
			blockhash: null,
		...
		},
		{
			...
			callArgs: toBuffer(cbor.encode(createAction.payload.callArgs)),
			chain: "ethereum",
			chain_id: "1",
			blockhash: null,
			source: null,
		},
		{
			...
			callArgs: toBuffer(cbor.encode(voteAction.payload.callArgs)),
			chain: "ethereum",
			chain_id: "1",
			blockhash: null,
			source: null,
		},
		{
			...
			callArgs: toBuffer(cbor.encode(voteSourceAction.payload.callArgs)),
			chain: "ethereum",
			chain_id: "1",
			blockhash: null,
			source: null,
