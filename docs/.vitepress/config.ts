					...
					items: [
						...
						{ text: "Hooks", link: "/readme-hooks.md" },
						{
							...
							items: [
								...
								{ text: "Ethereum Signer", link: "/readme-chain-ethereum.md" },
								{ text: "Ethereum Signer (Viem)", link: "/readme-chain-ethereum-viem.md" },
								{ text: "Bluesky Signer", link: "/readme-chain-atp.md" },
								{ text: "Solana Signer", link: "/readme-chain-solana.md" },
								{ text: "Cosmos Signer", link: "/readme-chain-cosmos.md" },
								{ text: "Substrate Signer", link: "/readme-chain-substrate.md" },
							],
						},
					],
				},
