...
export const LoginSelect = ({ selected, setSelected }) => {  

  return (
    <Listbox value={selected} onChange={setSelected}>
      {({ open }) => (
        <>
          <Listbox.Label className="block text-sm font-medium leading-6 text-gray-900">Login with:</Listbox.Label>
                    ...
                    {({ selected, active }) => (
                      <>
                        <div className="flex items-center">
                          <img src={loginOption.avatar} alt="" className="h-5 w-5 flex-shrink-0 rounded-full" />
                          <span
