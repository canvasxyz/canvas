...
import { ServiceMap, libp2p } from "./libp2p"
...
export const App: React.FC<AppProps> = (props) => {
	...
	useEffect(() => {
		if (user === null) {
			...
			if (managerRef.current === null && !isManagerStarting.current) {
				...
				RoomManager.initialize(libp2p, user)
	...
	return (
		<AppContext.Provider value={{ manager, libp2p, user, setUser, pageTitle, setPageTitle, roomId, setRoomId }}>
